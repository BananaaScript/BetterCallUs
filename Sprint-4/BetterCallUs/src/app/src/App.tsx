        ...
        <footer>
          <div className='cima'>
            ...
            <div className='parte2'>
              <a href="https://github.com/CODE1na/BetterCallUs" target ="_blank"> <img src={logoGithub} alt="Github" title="Logo Github" /></a>
              <a href="https://www.instagram.com/bettercallus.code/?next=%2F" target="_blank"> <img src={logoInsta} alt="Instagram" title="Logo Instagram" /></a>
              <a href="https://www.tiktok.com/@bettercallus.code" target="_blank"> <img src={logoTiktok} alt="Tiktok" /></a>
              <a href="https://twitter.com/better_code_us" target="_blank"> <img src={logoTwitter} alt="Twitter" /></a>
              </div>
