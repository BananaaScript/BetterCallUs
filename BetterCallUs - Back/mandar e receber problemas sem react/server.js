...
// Configurar a pasta onde seus arquivos estáticos (HTML, JS, CSS) estão localizados
app.use(express.static('public')); // Substitua 'public' pelo caminho real para seus arquivos
